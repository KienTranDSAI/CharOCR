...
def getDetBoxes_core(textmap, linkmap, text_threshold, link_threshold, low_text):
    ...
    np.save(f"/home/app/ocr/kientdt/CharOCR/CRAFT/outputs/array_img/textscore.npy", text_score)
    ...
    for k in range(1, nLabels):
        ...
        np.save(f"/home/app/ocr/kientdt/CharOCR/CRAFT/outputs/array_img/label_{k}.npy", segmap)
    ...
    return det, labels, mapper, segmap_list
...
def getDetBoxes(textmap, linkmap, text_threshold, link_threshold, low_text, poly=False):
    boxes, labels, mapper, segmap_list = getDetBoxes_core(
    ...
    return boxes, polys, segmap_list
